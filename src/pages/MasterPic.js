                ...
                <Modal toggle={this.openModalAdd} isOpen={this.state.modalAdd}>
                    ...
                    <ModalBody>
                        <div className="addModalDepo">
                            ...
                            <Input type="name" name="nama_pic" className="col-md-9"/>
                        </div>
                        <div className="addModalDepo">
                            <text className="col-md-3">
                                Nama SPV
                            </text>
                            <Input type="name" name="nama_spv" className="col-md-9"/>
                        </div>
                        <div className="addModalDepo">
                            <text className="col-md-3">
                                Divisi
                ...
                <Modal toggle={this.openModalEdit} isOpen={this.state.modalEdit}>
                    ...
                    <ModalBody>
                        <div className="addModalDepo">
                            ...
                            <Input type="name" name="nama_pic" value="Anjar" className="col-md-9"/>
                        </div>
                        <div className="addModalDepo">
                            <text className="col-md-3">
                                Nama SPV
                            </text>
                            <Input type="name" name="nama_spv" value="Lulu Istiqomah" className="col-md-9"/>
                        </div>
                        <div className="addModalDepo">
                            <text className="col-md-3">
                                Divisi
