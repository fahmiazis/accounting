...
import { Input, Container, Form, Alert, Modal, ModalBody, Spinner,
    Button, FormGroup, Label, Row, Col, Card, CardBody, CardTitle,
 } from 'reactstrap'
        ...
        return (
            <>
                <Formik
                    ...
                    <Container fluid className="d-flex align-items-center justify-content-center min-vh-100" style={{ backgroundImage: `url(${officeImg})`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
                        <Row className="w-75">
                        <Col sm="12" md="10" lg="5" className="mx-auto"> {/* Menggunakan 'lg-4' agar tidak terlalu lebar di desktop */}
                            ...
                            <CardBody>
                                ...
                                <CardTitle tag="h6" className="text-start text-danger mb-3">
                                    <AiOutlineCopyrightCircle size={18} className="mr-2" />ACCOUNTING-PMA 2021
                                </CardTitle>
                            </CardBody>
                            </Card>
                        </Col>
