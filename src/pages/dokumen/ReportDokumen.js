...
class ReportDokumen extends Component {
            ...
            <>
                <div className={styleTrans.app}>
                    ...
                    <div className={`${styleTrans.mainContent} ${this.state.sidebarOpen ? styleTrans.collapsedContent : ''}`}>
                        ...
                        <h2 className={styleTrans.pageTitle}>Report Dokumen</h2>
                                ...
                                <div className="secSearch mr-4">
                                    ...
                                    { level === '5' || level === '4' ? (
                                        ...
                                        <DropdownMenu >
                                            ...
                                            <DropdownItem className="item" onClick={() => this.setState({limit: 'all'})}>All</DropdownItem>
                                        </DropdownMenu>
                                        </ButtonDropdown>
                                    ) : (
                                        <ButtonDropdown className="drop" isOpen={dropOpen} toggle={this.dropDown}>
...
export default connect(mapStateToProps, mapDispatchToProps)(ReportDokumen)