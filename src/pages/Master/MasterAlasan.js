            ...
            <>
                <div className={styleTrans.app}>
                    ...
                    <div className={`${styleTrans.mainContent} ${this.state.sidebarOpen ? styleTrans.collapsedContent : ''}`}>
                        ...
                        <h2 className={styleTrans.pageTitle}>Master Alasan</h2>
                        ...
                        <table className={`${styleTrans.table} ${dataAlasan.length > 0 ? styleTrans.tableFull : ''}`}>
                            <thead>
                                <tr>
                                    <th>No</th>
                                    <th>Kode Alasan</th>
                            ...
                            {dataAlasan.length !== 0 && dataAlasan.map(item => {
                                ...
                                <tr onClick={() => this.openModalEdit(this.setState({detail: item}))}>
                                    <td>{(dataAlasan.indexOf(item) + (((page.currentPage - 1) * page.limitPerPage) + 1))}</td>
