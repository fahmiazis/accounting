            ...
            <>
                <div className={styleTrans.app}>
                    ...
                    <div className={`${styleTrans.mainContent} ${this.state.sidebarOpen ? styleTrans.collapsedContent : ''}`}>
                        ...
                        <div className={styleTrans.searchContainer}>
                            <div>
                                ...
                                <DropdownMenu>
                                    ...
                                    <DropdownItem className="item" onClick={() => this.getDataDokumen({limit: 'all', search: ''})}>all</DropdownItem>
                                </DropdownMenu>
                                </ButtonDropdown>
                        ...
                        <table className={`${styleTrans.table} ${dataDokumen.length > 0 ? styleTrans.tableFull : ''}`}>
                            <thead>
                                <tr>
                                    <th>
                                        <input  
