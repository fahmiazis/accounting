                    ...
                    <div className={`${styleTrans.mainContent} ${this.state.sidebarOpen ? styleTrans.collapsedContent : ''}`}>
                        ...
                        <div className={styleTrans.searchContainer}>
                            <div>
                                ...
                                <DropdownMenu>
                                    <DropdownItem className={style.item} onClick={() => this.getDataInventory({limit: 10, search: ''})}>10</DropdownItem>
                                    <DropdownItem className={style.item} onClick={() => this.getDataInventory({limit: 20, search: ''})}>20</DropdownItem>
                                    <DropdownItem className={style.item} onClick={() => this.getDataInventory({limit: 50, search: ''})}>50</DropdownItem>
                                </DropdownMenu>
                                </ButtonDropdown>
                        ...
                        <div className={styleTrans.searchContainer}>
                            <div className='rowCenter'>
                                ...
                                <Button className='mr-1' disabled={listInventory.length === 0 ? true : false} onClick={this.openModalDelete} color="danger" size="lg">Delete</Button>
                        ...
                        <table className={`${styleTrans.table} ${dataInventory.length > 0 ? styleTrans.tableFull : ''}`}>
                            <thead>
                                <tr>
                                    <th>
                                        <input  
                            ...
                            {dataInventory.length !== 0 && dataInventory.map(item => {
                                return (
                                    <tr>
                                        ...
                                        <td className={styleTrans.colNo}>{(dataInventory.indexOf(item) + (((page.currentPage - 1) * page.limitPerPage) + 1))}</td>
                                        <td>{item.plant}</td>
                                        <td>{item.area}</td>
                                        <td>{item.channel}</td>
                        ...
                        {dataInventory.length === 0 && (
                            <div className={style.spinCol}>
                                ...
                                <div className='textInfo'>Data inventory tidak ditemukan</div>
                            </div>
                        )}
                        <div>
